...
void ULoadoutSelectionView::SetCardInfo(FText& inName, EOBWeaponSlot inSlot, FText& inCategory, FText& inDesc, UTexture2D* inIcon)
{
	...
	CardPtr->SetLoadoutCard(inName, inSlot, inCategory, inDesc, inIcon);
}
