...
/**
 왜 존재하는가?
 - 같은 장소를 반복 파밍해도 나오는 게 달라지도록, 확정 드랍이 아닌 가중치 추첨을 쓴다.
 - DT_LootTables의 행 하나 = 드랍 테이블 하나(Common / Rare / Zombie ...).
 멀티플레이 역할?
...
USTRUCT(BlueprintType)
struct OUTBREAK_API FOBLootTableRow : public FTableRowBase
{
	GENERATED_BODY()
