...
namespace OBGameplayTags
{
	...
	OUTBREAK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_HoldStyle_Unarmed);
	OUTBREAK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_HoldStyle_Rifle);
	OUTBREAK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_HoldStyle_Pistol);
	OUTBREAK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_HoldStyle_Melee);
	OUTBREAK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_HoldStyle_Heal);
	OUTBREAK_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_HoldStyle_Grenade);
